...
physics_nodes/SKPPlatform.cpp \
physics_nodes/SKPContactsListener.cpp \
physics_nodes/SKPHero.cpp \
...
LOCAL_CFLAGS += -DCC_ENABLE_BOX2D_INTEGRATION=1
LOCAL_EXPORT_CFLAGS += -DCC_ENABLE_BOX2D_INTEGRATION=1

LOCAL_CPPFLAGS += -DCC_ENABLE_BOX2D_INTEGRATION=1
LOCAL_EXPORT_CPPFLAGS += -DCC_ENABLE_BOX2D_INTEGRATION=1
