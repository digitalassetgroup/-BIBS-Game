...
static const char * kAnimationPath          = "SampleAnimations/enemy_slime/1HNYAK0T5VWH.json";
static const char * kNamedAnimationPath     = "SampleAnimations/named/15RA700WMMJR.json";
...
void GafApi::addToScene(GAFAnimatedObject * object, float px, float py, const char * sequenceName)
{
	...
	if (sequenceName)
	{
		object->setSequence(sequenceName, true);
	}
}
