...
bool GafFeatures::init()
{
	...
	_jsons.push_back("SampleAnimations/enemy_slime/1HNYAK0T5VWH.json");
	_jsons.push_back("SampleAnimations/fireman/0619WC0I55O0.json");
	_jsons.push_back("SampleAnimations/coin/coin.json");
	_jsons.push_back("SampleAnimations/simpleMovement/simpleMovement.json");
	_jsons.push_back("SampleAnimations/blurTest/blurTest.json");
	_jsons.push_back("SampleAnimations/moveScaleRotate/moveScaleRotate.json");
	_jsons.push_back("SampleAnimations/simpleMovementWithColor/simpleMovementWithColor.json");
	_jsons.push_back("SampleAnimations/newMaskTest/newMaskTest.json");
	_jsons.push_back("SampleAnimations/masksTest/masksTest.json");
#if 0	
	_jsons.push_back("SampleAnimations/colorTransformTest/colorTransformTest.json");
	_jsons.push_back("SampleAnimations/multiAtlasesTest/1BPM2302S80NAsset.json");
	_jsons.push_back("SampleAnimations/named/1BPM211BI6SRAsset.json");
#endif
