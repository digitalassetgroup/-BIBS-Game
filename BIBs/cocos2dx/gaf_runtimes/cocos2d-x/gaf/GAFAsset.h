...
public :
	...
	static void setScalingParameters(float currentDeviceScale, bool makeExactScaleForObject);
	...
	GAFAnimationSequence   * getSequenceByEndFrame(int frame);
...
private:
	...
	float getAtlasSclae(CCDictionary * atlas);
	int _majorVersion;
	int _minorVersion;
