...
static void (*_errorFunc)(const char*) = NULL;
//----
void LuaState::SetErrorHandler(void (*errorFunc)(const char*))
{
	_errorFunc = errorFunc;
}

bool LuaState::HandleError(const char* errorString)
{
	if (_errorFunc != NULL)
		_errorFunc(errorString);
	return (_errorFunc != NULL);
}
