...
static NSString * const kAnimationPath      = @"SampleAnimations/enemy_slime/1HNYAK0T5VWH.json";
static NSString * const kNamedAnimationPath = @"SampleAnimations/named/15RA700WMMJR.json";
