...
public:
	...
	static GAFTextureAtlas * create(const char * jsonPath, CCDictionary * aConfigDictionary, CCArray * anImageDatas);
	bool init(const char * jsonPath, CCDictionary * aConfigDictionary, CCArray * anImageDatas);
