...
-(id) init
{
	if( (self=[super init]) )
	{
		...
		[_jsons addObject:@"SampleAnimations/fireman/0HXY1K187M1W.json"];
		[_jsons addObject:@"SampleAnimations/multiAtlasesTest/multiAtlasesTest.json"];
		[_jsons addObject:@"SampleAnimations/moveScaleRotate/0HXY1L07QOV3.json"];
		[_jsons addObject:@"SampleAnimations/named/named.json"];
		[_jsons addObject:@"SampleAnimations/enemy_slime/export_enemy_slime.json"];
		[_jsons addObject:@"SampleAnimations/simpleMovement/simpleMovement.json"];
		[_jsons addObject:@"SampleAnimations/newMaskTest/0619Y107L3KU.json"];
		[_jsons addObject:@"SampleAnimations/colorTransformTest/colorTransformTest.json"];
		[_jsons addObject:@"SampleAnimations/masksTest/0619Y107TLUV.json"];
		[_jsons addObject:@"SampleAnimations/blurTest/0ZSY6X07Y6X7.json"];
