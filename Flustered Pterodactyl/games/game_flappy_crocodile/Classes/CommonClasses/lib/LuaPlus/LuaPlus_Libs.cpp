...
extern "C" int LS_LuaDumpObject( lua_State* luaState )
{
	LuaStateOutFile file;

	LuaState* state = lua_State_To_LuaState(luaState);
	LuaStack args(state);
...
extern "C" int LS_LuaDumpFile( lua_State* luaState )
{
	return LS_LuaDumpObject(luaState);
}
